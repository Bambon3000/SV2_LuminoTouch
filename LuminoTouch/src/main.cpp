...
#define S_SETUP_MENU 0  // Hauptmenü-Setup-State
#define S_MENU 1        // Hauptmenü-State
#define S_TTT 2         // Tic-Tac-Toe-State
#define S_MEMSEQ 3      // Memory-Sequence-State
#define S_COLSEQ 4      // Color-Sequence-State
#define S_PSM 5         // Power-Saving-Mode-State
